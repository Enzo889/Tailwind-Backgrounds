...
const Playground: React.FC<PlaygroundProps> = ({
  ...
  return (
    <>
      <div className="relative min-h-[300px] w-full overflow-hidden rounded-lg ring-1 ring-slate-900/10  border  border-solid border-emerald-500  shadow-2xl hover:border-2 ">
